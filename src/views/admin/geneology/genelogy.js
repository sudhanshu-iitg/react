...
const GenoCard = ({
  ...
  const [showLinkGenerateModal, setShowLinkGenerateModal] = useState(false);
  ...
  return data ? (
    ...
    <>
      ...
      >
        ...
        <Modal
          open={showLinkGenerateModal}
          onClose={() => setShowLinkGenerateModal(false)}
          aria-labelledby="modal-modal-title"
          aria-describedby="modal-modal-description"
        >
          <Box
          ...
          >
            <Grid>
              <Button
                onClick={() => setShowLinkGenerateModal(false)}
                style={{ float: "right" }}
              >
                {" "}
                <CloseRoundedIcon
            ...
            <Grid>
              <Grid>
                <CustomButton
                  ...
                  onClick={() => {
                    setShowLinkGenerateModal(false);
                    generateLink();
                  }}
                />
              </Grid>
        ...
        <Grid item>
          <div
            ...
            onClick={() => setShowLinkGenerateModal(true)}
          >
            {" "}
